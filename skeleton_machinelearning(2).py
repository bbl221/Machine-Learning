...
X = mnist["data"].values #changed the .values because I was on panda
...
def plot_digit(data):
    plt.imshow(data.reshape(28,28), cmap = plt.cm.binary,interpolation="nearest")
    plt.axis("off")
    plt.show()
...
print("scores for some_digit=", some_digit_performance)
#
